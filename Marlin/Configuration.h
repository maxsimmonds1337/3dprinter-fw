...
#define Y_MAX_POS 200				// Changed from 200
...
#define HOMING_FEEDRATE {5000, 5000, 50, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 2560, 708.3850}  // default steps per unit for Ultimaker
...
#define DEFAULT_XYJERK                15.0    // (mm/sec)        // Changed from 20.0
